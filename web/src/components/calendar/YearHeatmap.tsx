...
export function YearHeatmap({ start, end, volumeByDate, onPickDate }: Props) {
  ...
  const gridCols = { gridTemplateColumns: `repeat(${weeks.length}, minmax(11px, 1fr))` };

  return (
    <div className="overflow-x-auto pb-1">
      {/* Les etiquetes poden sobresortir cap a la dreta: hi ha prou espai
          entre mesos i així no cal retallar-les. */}
      <div className="mb-1.5 grid gap-[3px] pl-8" style={gridCols}>
        {weeks.map((_, i) => (
      ...
      {/* Llegenda */}
      <div className="mt-3 flex items-center gap-2 pl-8 text-[11px] text-ink-500">
        <span>−</span>
